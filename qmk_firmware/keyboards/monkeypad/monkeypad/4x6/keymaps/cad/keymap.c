...
#define KC_G_JA     GUI_T(KC_LNG1)
#define KC_G_EN     GUI_T(KC_LNG2)
#define KC_G_TAB    MT(MOD_LGUI, KC_TAB)

/* for Fusion 360 users */
enum custom_keycodes {
    CTM_BTN1, // toggle wheel click
    CTM_BTN2  // toggle shift + wheel click
};
...
//  Left hand sub board keys                                    Right hand sub board keys
    ...
    TG(_GAME), KC_LALT, KC_LCTL, KC_G_EN, KC_R_ENT, KC_L_SPC,   KC_L_BS, KC_R_ENT,KC_G_JA, KC_RCTL,KC_RALT, TG(_FUNC),
...
//                                      Left hand module        Right hand module
  ...
  [_FUNC] = LAYOUT_module(
    ...
    XXXXXXX, KC_MNXT, KC_VOLU, XXXXXXX, DPI_UP,  XXXXXXX,       RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_SPI, RGB_TOG,
    KC_BRIU, KC_MPLY, KC_MUTE, XXXXXXX, DPI_RST, DPI_FINE,      RGB_RMOD,RGB_HUD, RGB_SAD, RGB_VAD, RGB_SPD, XXXXXXX,
    KC_BRID, KC_MPRV, KC_VOLD, XXXXXXX, DPI_DN,  XXXXXXX,       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_TRNS,
                                        KC_BTN1, KC_BTN2,       KC_BTN1, KC_BTN2,
                              KC_VOLD,  KC_MUTE, KC_VOLU,       KC_VOLD, KC_MUTE, KC_VOLU
  ),
  [_GAME] = LAYOUT_module(
    KC_DEL,  _______, KC_WH_U, _______, KC_BSPC, _______,       _______, KC_7,    KC_8,    KC_9,   KC_PPLS, KC_MINS,
    _______, KC_WH_L, KC_WH_D, KC_WH_R, KC_ENT,  _______,       _______, KC_4,    KC_5,    KC_6,   KC_PAST, KC_PENT,
    _______, KC_UNDO, KC_CUT,  KC_COPY, KC_PSTE, _______,       _______, KC_1,    KC_2,    KC_3,   KC_SLSH, KC_PEQL,
    _______, _______, _______, _______, KC_BTN1, KC_BTN2,       KC_BTN1, KC_BTN2, KC_0,    KC_DOT, _______, _______,
                                        CTM_BTN1,CTM_BTN2,      KC_BTN1, KC_BTN2,
                              KC_WH_D,  KC_BTN3, KC_WH_U,       KC_WH_D, KC_BTN3, KC_WH_U
  ),
};
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
        case CTM_BTN1:
            ...
            return false; // Skip the normal key process
            break;
        case CTM_BTN2:
            if (record->event.pressed) {
                if (!btn1_held) {
