...
MODULE_DEVICE_LEFT = pmw3360
MODULE_DEVICE_RIGHT = analog_joystick

# If you are using different pointing devices (analog_joystick / pmw3360) on the left and right,
...
POINTING_MODULE_NAME := analog_joystick pmw3360
...
#	if it has at least one pointing device
	ifeq ($(strip $(TARGET_POINTING_DEVICE)), encoder)
		ifeq ($(or $(findstring pmw3360,$(MODULE_DEVICE_LEFT)), $(findstring pmw3360,$(MODULE_DEVICE_RIGHT))),pmw3360)
...
#	Set pointing device driver on TARGET_POINTING_DEVICE
	ifeq ($(strip $(TARGET_POINTING_DEVICE)), pmw3360)
