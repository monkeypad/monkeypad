...
![](../images/01/monkeypad_1_01.jpeg)
  ...
  - [10. 組み立て](10_組み立て.md)
    - [10-1. サブボードの組み立て）](./10_組み立て.md/#10-1メインボードの組み立て)
    - [10-2. ゴムパッド、三脚アダプタの取り付け）](./10_組み立て.md/#10-2三脚アダプタの取り付け)
    - [10-3. メインボードの組み立て）](./10_組み立て.md/#10-3サブボードの組み立て)
    - [10-4. メインボードの組み立て）](./10_組み立て.md/#10-4ゴムパッドの貼り付け)
  - [11. 完成!](11_完成.md)
